...
def generate_test_description():
    """Launch CUDA tensor inference across separate Fast DDS processes."""
...
class TestOnnxRuntimeCudaTensorInterPubSubFastRTPS(unittest.TestCase):
    ...
    def _publisher_count(self, msg):
        self.publisher_count = msg.data

    def _subscriber_count(self, msg):
        self.subscriber_count = msg.data

    def _validation_result(self, msg):
        self.validation_passed = msg.data

    def test_inter_process_cuda_inference(self):
