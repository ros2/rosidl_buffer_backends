...
if(DEFINED TEST_CUDA_VERSION)
  libtorch_cuda_vendor_variant_for_cuda("${TEST_CUDA_VERSION}" variant)
  return()
endif()
...
foreach(pair IN ITEMS "cu126,12.6" "cu126,12.8" "cu130,13.1" "cu130,13.2" "cu132,13.2")
  ...
  libtorch_cuda_vendor_validate_variant_for_cuda("${variant}" "${version}")
endforeach()
...
foreach(pair IN ITEMS "cu132,13.1" "cu126,12.4" "cu130,12.8" "cpu,13.1")
  ...
  list(GET fields 0 variant)
  list(GET fields 1 version)
  libtorch_cuda_vendor_cuda_compatible("${variant}" "${version}" compatible)
  if(compatible)
    message(FATAL_ERROR "Incompatible installed CUDA build ${pair} must not be reused")
  endif()
endforeach()
libtorch_cuda_vendor_cuda_compatible("cu130" "13.1.115" compatible reason)
if(NOT compatible)
