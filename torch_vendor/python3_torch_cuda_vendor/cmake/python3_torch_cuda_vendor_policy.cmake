...
set(PYTHON3_TORCH_CUDA_VENDOR_TORCH_VERSION "2.14.0")
set(PYTHON3_TORCH_CUDA_VENDOR_SUPPORTED_VARIANTS cu126 cu130 cu132)

function(python3_torch_cuda_vendor_validate_variant variant)
  list(FIND PYTHON3_TORCH_CUDA_VENDOR_SUPPORTED_VARIANTS "${variant}" index)
  if(index EQUAL -1)
    message(FATAL_ERROR "Unsupported Torch variant '${variant}'; use ${PYTHON3_TORCH_CUDA_VENDOR_SUPPORTED_VARIANTS}")
  endif()
endfunction()
...
function(python3_torch_cuda_vendor_cuda_compatible variant cuda_version output_variable)
...
function(python3_torch_cuda_vendor_validate_variant_for_cuda variant cuda_version)
  python3_torch_cuda_vendor_validate_variant("${variant}")
  python3_torch_cuda_vendor_cuda_compatible("${variant}" "${cuda_version}" compatible reason)
  if(NOT compatible)
