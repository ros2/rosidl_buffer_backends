...
set(PYTHON3_TORCH_CUDA_VENDOR_SUPPORTED_VARIANTS cu130 cu132)
...
function(python3_torch_cuda_vendor_validate_variant variant)
  ...
  if(index EQUAL -1)
    message(FATAL_ERROR "Unsupported fallback Torch variant '${variant}'; use ${PYTHON3_TORCH_CUDA_VENDOR_SUPPORTED_VARIANTS}")
  endif()
endfunction()
...
function(python3_torch_cuda_vendor_validate_variant_for_cuda variant cuda_version)
  python3_torch_cuda_vendor_variant_for_cuda("${cuda_version}" default_variant)
